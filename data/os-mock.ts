...
export const osTasks = [
  {
    ...
    tmuxSession: 'garrettos_t1',
    locked: true,
    startedAt: '2026-06-29T17:20:00+00:00',
    contextPath: '/root/garrettos-logs/t1.context.md',
    contextBytes: 3120,
    contextSources: ['vault/current_context.md', 'vault/active_projects.md', 'repo/README.md', 'repo/git-status'],
    memoryInjected: true,
    contextPreview: '# GarrettOS Agent Context Bundle\n\n- generated: 2026-06-29T17:20:01+00:00\n- host: hetzner-vps\n- sources: 5\n\n### vault/current_context.md\n\nWorking on Garmin HRV ingestion pipeline.\n',
  },
  {
    id: 't2',
    title: 'Schema review',
    ...
    completedAt: '2026-06-29T16:40:00+00:00',
    contextPath: '/root/garrettos-logs/t2.context.md',
    contextBytes: 2870,
    contextSources: ['vault/decisions.md', 'vault/active_projects.md', 'repo/README.md'],
    memoryInjected: true,
  },
  {
    id: 't3',
    title: 'VPS health probe',
    status: 'blocked' as const,
    agent: 'OpenCode',
    priority: 'high' as const,
    nextAction: 'Agent exited nonzero — review the log tail and re-queue',
    logPath: '/root/garrettos-logs/t3.log',
    lastLogTail: 'Error: connection refused on port 8788\n  at probe (/root/health.js:12:9)\n__GARRETTOS_EXIT__:1',
    completedAt: '2026-06-29T16:10:00+00:00',
    contextPath: '/root/garrettos-logs/t3.context.md',
    contextBytes: 1940,
