...
export function MetricCard({
  ...
  // Hero / progress / alert variants get the fluid (reactive) glass surface;
  // compact / sparkline / dual stay on plain GlassPanel to avoid over-animating.
...
function MetricCardInner({
  ...
  tone: StatusTone;
  icon?: React.ReactNode;
  resolvedVariant: 'hero' | 'compact' | 'sparkline' | 'progress' | 'dual' | 'alert';
  secondaryLabel?: string;
  secondaryValue?: React.ReactNode;
  progress?: number;
  sparkline?: React.ReactNode;
